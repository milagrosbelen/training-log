              ...
              <button
                ...
                className={`text-xs sm:text-sm px-3 sm:px-4 py-2 rounded-lg font-medium transition-all duration-200 ${
                  currentView === "calendar"
                    ? "bg-neon-500 text-white shadow-md shadow-neon-500/20"
            ...
            {workouts.length === 0 && !selectedDate ? (
              <div className="flex flex-col items-center justify-center min-h-[60vh] text-center space-y-6">
                ...
                <button
                  ...
                  className="bg-neon-500 hover:bg-neon-600 text-white font-semibold py-3 px-6 rounded-xl transition-all duration-200 flex items-center justify-center gap-2 text-sm sm:text-base shadow-lg shadow-neon-500/20 hover:shadow-neon-500/30 hover:scale-[1.02] active:scale-[0.98]"
                >
